...
default_df = default_df[['Unique_ID', 'Item', 'Category', 'Family', 'Material', 'Sales Date', 'Sales Quantity', 'Invoice Date', 'Invoice Quantity', 'Date Difference']]
...
def update_bar_plots(category_filter, family_filter, material_filter, item_filter, sort_order):
    ...
    category_fig.update_layout(title='Average Lead Time by Category', xaxis_title='Category', yaxis_title='Average Lead Time')
    ...
    material_fig.update_layout(title='Average Lead Time by Material', xaxis_title='Material', yaxis_title='Average Lead Time')
